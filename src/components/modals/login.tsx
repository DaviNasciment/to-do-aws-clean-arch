...
import { HiAtSymbol, HiFingerPrint, HiOutlineEye, HiOutlineEyeOff, HiX } from 'react-icons/hi';
            ...
            <div ref={modalRef} className="rounded-lg md:max-w-sm z-10 w-full">
                ...
                <div className="relative bg-[#1e1e1e] rounded-lg shadow w-full">
                    ...
                    <div className="flex items-start justify-between rounded-t relative">
                        <span onClick={onClose} className="absolute cursor-pointer right-2 top-2 bg-[#1e1e1e] p-2 rounded-md hover:text-[#fcc83a] transition-all"><HiX /></span>
